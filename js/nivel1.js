...
//xalert ("Mi nombre es"+ nombre + " y mi edad es" + edad);
...
function restar( número5, número1) {
    return número5-número1;
}   
...
//let edadUsuario= prompt ("Por favor, ingrese su edad: " , "+18")
...
/*
function restar(AñoActual, AnioDeNacimiento) {
    return AñoActual - AnioDeNacimiento;
}

const AñoActual= Number(prompt("¿Que año actualmente es?"));
const AnioDeNacimiento= Number(prompt ("¿En que año naciste?"));

const edadUsuario= restar(AñoActual, AnioDeNacimiento);
...
/*
const salarioAnual = Number(prompt("Introduce tu salario anual para saber tu salario mensual:"));
...
console.log (
    "Tu salario es: " + dividir(salarioAnual) + " pesos"
);
*/

/*
const salarioMensual= Number (prompt("Introducí tu salario mensual para saber tu salario anual:"));

function multiplicación(salarioMensual) {
    const AñoTotal= 12;
    return salarioMensual * AñoTotal;
}


console.log (
    "tu salario anual es " + multiplicación(salarioMensual) + " pesos"
);
*/

/*
const salarioMensual= Number (prompt("Introducí tu salario mensual para saber tu salario semanal:"));

function división(salarioMensual, salarioSemanal) {
    const salarioSemanal= 4;
    return salarioMensual/salarioSemanal;
}


console.log (
    "Tu salario es: " + división(salarioMensual) + " Pesos Por Semana"
);
*/

/*
const salarioSemanalTotal= Number(prompt("Introducí tu salario semanal para saber tu salario por hora:"));

function división(salarioSemanalTotal) {
    const salarioPorHora = 168;
    return salarioSemanalTotal/salarioPorHora;
}


console.log (
    "Tu salario es: " + división(salarioSemanalTotal) + " Pesos Por hora"
);
*/
...
function calcularMesesVividos (mesesVividos) {
    console.log("Cuantos meses viviste?: " + mesesVividos);
    console.log ("Cuantos años viviste?: " + añosVividos);
    console.log ("Mes de nacimiento: " + mesdenacimiento)
    const AñoActual=2022;
    return (AñoActual - añosVividos) * 12 + mesdenacimiento;
}

let mesesVividos;
let añosVividos= Number(prompt("En que año naciste?"));
let mesdenacimiento= Number(prompt("En que mes naciste?"));

console.log ("Tenés " + calcularMesesVividos(mesesVividos) + " meses vividos");
*/
...
/*
    ...
    Qué pasa si en nuestro programa queremos decidir sobre qué función debería ejecutarse? 
    Tenemos que usar condicionales!
...
/*
console.log("El resultado es " + prompt("ingrese + o -"));
*/
...
simbolo= prompt("Inserte su simbolo aquí")

if (simbolo ==="-") {
    console.log(resultado= restar (NumeroUno,NumeroDos));
} else if (simbolo ==="/") {
    console.log(resultado= dividir (NumeroUno,NumeroDos));
} else if (simbolo === "*") {
...
/*
const preguntarEdadUsuario = Number(prompt ("¿Que edad tenes?"));

if (preguntarEdadUsuario === 26) {
    console.log("Tenés la misma edad que yo, ${NombreUsuario}")
} else if (preguntarEdadUsuario>=26) {
    console.log ("Tenés más edad que yo, ${NombreUsuario}")
} else if (preguntarEdadUsuario=>27){
    console.log ("Tenés menos edad que yo, ${NombreUsuario}")
}
*/
...
/*
let UsuarioDocumento= prompt ("¿Tenés documento").toLocaleLowerCase();

if (UsuarioDocumento==="si") {

    let UsuarioEdad=Number(prompt("¿Cúal es tu edad?"))
 
    if (UsuarioEdad===18) {
        alert("Si podes entrar al bar")
    } 
...
/**************************COPIA DE SEGURIDAD4**************************/
/*
let UsuarioDocumento= prompt ("¿Tenés documento");
