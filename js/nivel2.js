...
//const comidasFavoritas= ["milanesas","asado","fugazzetas","faina"];
...
//       diez a uno.
// HINT: Los contadores pueden para arriba o para abajo.
...
console.log ("El promedio total es: " + TotalNotas/ NotasParciales.length);
*/


//Ejercicio

//Tarea hacer una función que se llama CalcularPromedio
...
if (ResultadoFizz===0) {
    fizz(ResultadoFizz) 
} else if (ResultadoBuzz===0) {
    buzz(ResultadoBuzz) 
} else if (ResultadoFizzBuzz===0) {
...
function fizz(ResultadoBuzz) {
    const ResultadoDeDividirDeACinco=0;
    ResultadoBuzz= NumeroUsuario/5;
    ResultadoTotal = ResultadoFizzBuzz;
 }
 function fizz(ResultadoFizzBuzz) {
    const ResultadoDeDividirDeAMultiploDeCincoYTres=0;
    ResultadoFizzBuzz= NumeroUsuario/15;
    ResultadoTotal = ResultadoFizzBuzz;
 }

if (ResultadoTotal===100%3) {
    console.log("El número es: "+fizz(ResultadoFizz) )
} else if (ResultadoTotal===100%5) {
    console.log("El número es: "+fizz(ResultadoBuzz) )
} else if (ResultadoTotal===15) {
    console.log ("El número es: "+fizz(ResultadoFizzBuzz))
} else {
    console.log ("El número es: " + NumeroUsuario);
}
*/
/***COPIA DE SEGURIDAD ***/
